...
//    func updatePadding()
//    {
//        self.frame.origin.x = self.frame.origin.x + leftPadding
//    }
...
//    }
    ...
    */
    ...
    fileprivate func updateLineColor() {
        if hasErrorMessage {
            ...
            lineView.alpha = editingOrSelected ? 20 : 0.5
        }
    }
    ...
    */
    ...
    - returns: The rectangle that the textfield should render in (1)
    */
...
//    }
    ...
    /**
     ...
     - parameter bounds: The current bounds of the field
     - returns: The rectangle that the textfield should render in (2)
     */
...
//    }
    ...
    /**
     ...
     - returns: The rectangle that the placeholder should render in (3)
     */
...
//    }
    ...
    */
    open func titleLabelRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
        var w: CGFloat = 40
        if leftImage == nil { w = 0}
    
        if editing {
            return CGRect(x: w, y: -10, width: bounds.size.width, height: titleHeight())
        }
        return CGRect(x: w, y: titleHeight(), width: bounds.size.width, height: titleHeight())
    }
    ...
    open func lineViewRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
        ...
        var w: CGFloat = 40
        if leftImage == nil { w = 0}
        return CGRect(x: w, y: bounds.size.height - height, width: bounds.size.width - w, height: height)
    }
     ...
     */
    @IBInspectable
    dynamic open var iconMarginLeft: CGFloat = 3 {
        didSet {
            updateFrame()
        }
    }
